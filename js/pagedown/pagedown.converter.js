...
//   var text = "Mee *rocks*.";
//
//   var converter = new Mee.Converter();
...
(function () {
  ...
  Mee.HookCollection = HookCollection;
  ...
  Mee.Converter = function () {
    var pluginHooks = this.hooks = new HookCollection();
    pluginHooks.addNoop("plainLinkText"); // given a URL that was encountered by itself (without markup), should return the link text that's to be given to this link
    pluginHooks.addNoop("preConversion"); // called with the orignal text as given to makeHtml. The result of this plugin hook is the actual mee source that will be cooked
    ...
    function _EscapeSpecialCharsWithinTagAttributes(text) {
      ...
      // don't conflict with their use in Mee for code, italics and strong.
      //
    ...
    function _DoAnchors(text) {
      //
      // Turn Mee link shortcuts into XHTML <a> tags.
      //
      //
    ...
    function _DoImages(text) {
      //
      // Turn Mee image shortcuts into <img> tags.
      //
      //
    ...
    function _ProcessListItems(list_str, list_type) {
      ...
      // an aspect of Mee's syntax that's hard to parse perfectly
      ...
      //
      //  Mee          rendered by WMD        rendered by MeeSharp
      //  ------------------------------------------------------------------
      //  1. first          1. first               1. first
      //  2. second         2. second              2. second
      //  - third           3. third                   * third
      //
      // We changed this to behave identical to MeeSharp. This is the constructed RegEx,
    ...
    function _EncodeCode(text) {
      //
      // Encode/escape certain characters inside Mee code runs.
      // The point is that in code, these characters are literals,
      // and lose their special Mee meanings.
      //
      // Encode all ampersands; HTML entities are not
      // entities within a Mee code span.
      text = text.replace(/&/g, "&amp;");
      // Do the angle bracket song and dance:
      text = text.replace(/</g, "&lt;");
      text = text.replace(/>/g, "&gt;");
      // Now, escape characters that are magic in Mee:
  ...
  }; // end of the Mee.Converter constructor
})();
